import { Body, Controller, ParseIntPipe, Post, Query, Res, UnauthorizedException } from '@nestjs/common';
...
export class TwoFactorAuthController {
    ...
    @Post('generate')
    async generate(@Query('userId', ParseIntPipe) userId: number, @Res() res: Response) {
    ...
    @Post('enable')
    async enable(@Body() twoFactorAuthCodeDto: TwoFactorAuthCodeDto): Promise<User> {
